                                        ...
                                        <form action="{{ route('service.update', $service->id) }}" method="post"
                                            ...
                                            <div class="">
                                                <label for="" class="label">Description
                                                    <br></label>
                                                <textarea name="description" id="" rows="4" class="form-control" style="margin-bottom:20px">{{ $service->description }}</textarea>
                                            </div>
                                            <div class="">
                                                ...
                                                <div style="margin-bottom:20px">
                                                    <label for="" class="label">
                                                        <input type="radio" class="" name="multi_bookings"
                                                            value="1" @if ($service->multiple_bookings == 1) checked @endif>
                                                        Yes</label>
                                                    <label for=""
                                                        class="label d-flex justify-content-center align-items-center">
                                                        <input type="radio" class="" name="multi_bookings"
                                                            value="0" @if ($service->multiple_bookings == 0) checked @endif>
                                                        No</label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                    ...
                                                    <div class="review-content-section">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <input type="date" class="form-control"
                                                                ...
                                                                value="{{ $service->service_starting_date }}">
                                                        </div>
                                                        <div class="">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <input type="date" class="form-control"
                                                            ...
                                                            value="{{ $service->service_ending_date }}">
                                                    </div>
                                                    <div class="">
